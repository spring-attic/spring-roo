...
public class MailCommands implements CommandMarker {
  ...
  public void installSenderEmail(
      @CliOption(key = {"host"}, mandatory = false, help = "The host server") final String host,
      @CliOption(key = {"port"}, mandatory = false, help = "The port used by mail server") final String port,
      @CliOption(key = {"protocol"}, mandatory = false, help = "The protocol used by mail server") final String protocol,
      ...
      @CliOption(key = {"starttls"}, mandatory = false,
          help = "If true, enables the use of the STARTTLS command ") final Boolean starttls,
      @CliOption(key = {"jndiName"}, mandatory = false,
          help = "The jndi name where the mail configuration has been defined") final String jndiName,
      @CliOption(key = {"profile"}, mandatory = false,
          help = "The profile where the properties will be set") final String profile,
      @CliOption(
          key = "module",
          mandatory = true,
          help = "The application module where to install the mail configuration. This option is available if there is more than one application module "
