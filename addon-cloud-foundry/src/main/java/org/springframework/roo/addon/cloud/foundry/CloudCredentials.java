...
public class CloudCredentials {
	...
	public CloudCredentials(final Map<String, String> properties) {
		this(properties.get(EMAIL_KEY), properties.get(PASSWORD_KEY), properties.get(URL_KEY));
	}
	...
	public boolean isSameAccount(final String url, final String email) {
		return StringUtils.equals(url, this.url) && StringUtils.equals(email, this.email);
	}
