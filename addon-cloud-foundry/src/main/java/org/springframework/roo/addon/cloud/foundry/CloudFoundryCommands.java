...
public class CloudFoundryCommands implements CommandMarker {
	...
	public void login(
		...
		@CliOption(key = "cloudControllerUrl", mandatory = false, help = "The cloud controller to target. Defaults to '" + UaaAwareAppCloudClient.CLOUD_FOUNDRY_URL + "'") final CloudControllerUrl cloudControllerUrl) {
