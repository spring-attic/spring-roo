...
public class CloudFoundryCommands implements CommandMarker {
	...
	public void login(@CliOption(key = "email", mandatory = false, help = "The user's email address") CloudLoginEmail loginEmail,
	...
	public void createService(@CliOption(key = "serviceType", mandatory = true, help = "The service type") ServiceConfiguration service,
	...
	public void deleteService(@CliOption(key = "serviceName", mandatory = false, help = "The name of the service instance to delete") CloudService service) {
	...
	public void bindService(@CliOption(key = "serviceName", mandatory = true, help = "The name of the service instance you want to bind") CloudService service,
	...
	public void unbindService(@CliOption(key = "serviceName", mandatory = true, help = "The name of the service instance you want to bind") CloudService service,
	                          @CliOption(key = "appName", mandatory = true, help = "The name of the application you want to bind the service to") CloudApp appName) {
	...
	public void push(@CliOption(key = "appName", mandatory = true, help = "The desired name of the application") CloudApp appName,
	...
	public void start(@CliOption(key = "appName", mandatory = true, help = "The name of the application to start") CloudApp appName) {
		cloudFoundryOperations.start(appName.getName());
	}

	@CliCommand(value = "cloud foundry stop app", help = "Stop an application")
	public void stop(@CliOption(key = "appName", mandatory = true, help = "The name of the application to stop") CloudApp appName) {
		cloudFoundryOperations.stop(appName.getName());
	}

	@CliCommand(value = "cloud foundry restart app", help = "Restart an application")
	public void restart(@CliOption(key = "appName", mandatory = true, help = "The name of the application to restart") CloudApp appName) {
		cloudFoundryOperations.restart(appName.getName());
	}

	@CliCommand(value = "cloud foundry delete app", help = "Delete an application")
	public void delete(@CliOption(key = "appName", mandatory = true, help = "The name of the application to delete") CloudApp appName) {
	...
	public void renameApp(@CliOption(key = "appName", mandatory = true, help = "The name of the application to rename") CloudApp appName,
	...
	public void instances(@CliOption(key = "appName", mandatory = true, help = "The name of the application to list and/or change the number instances for") CloudApp appName,
	...
	public void viewMemory(@CliOption(key = "appName", mandatory = true, help = "The name of the application to view or update the reservation for") CloudApp appName) {
	...
	public void updateMemory(@CliOption(key = "appName", mandatory = true, help = "The name of the application to view or update the reservation for") CloudApp appName,
	...
	public void crashes(@CliOption(key = "appName", mandatory = true, help = "The name of the application to view recent crashes for") CloudApp appName) {
	...
	public void crashLogs(@CliOption(key = "appName", mandatory = true, help = "The name of the application to view the crash logs for") CloudApp appName,
	...
	public void logs(@CliOption(key = "appName", mandatory = true, help = "The name of the application to view the logs for") CloudApp appName,
	                 @CliOption(key = "instance", mandatory = false, help = "The name specific instance of the application of interest") String instance) {
	...
	public void files(@CliOption(key = "appName", mandatory = true, help = "The name of the application to target") CloudApp appName,
	...
	public void viewApptats(@CliOption(key = "appName", mandatory = true, help = "The name of the application to target") CloudApp appName) {
	...
	public void mapUrl(@CliOption(key = "appName", mandatory = true, help = "The name of the application to bind the URL to") CloudApp appName,
	...
	public void unMapUrl(@CliOption(key = "appName", mandatory = true, help = "The name of the application to unbind the URL from") CloudApp appName,
	...
	@CliAvailabilityIndicator({"cloud foundry list apps", "cloud foundry bind service", "cloud foundry view crash logs", "cloud foundry view crashes", "cloud foundry create service", "cloud foundry delete app",
