...
enum ServiceLayerMethod {
	...
	DELETE (PersistenceCustomDataKeys.REMOVE_METHOD) {
		...
		public String getName(final ServiceAnnotationValues annotationValues, final JavaType entityType, final String plural) {
			if (StringUtils.hasText(annotationValues.getDeleteMethod())) {
				return annotationValues.getDeleteMethod() + entityType.getSimpleTypeName();
			}
			return null;
		}
	...
	FIND_ENTRIES (PersistenceCustomDataKeys.FIND_ENTRIES_METHOD) {
		...
		public String getName(final ServiceAnnotationValues annotationValues, final JavaType entityType, final String plural) {
			if (StringUtils.hasText(annotationValues.getFindEntriesMethod())) {
				return annotationValues.getFindEntriesMethod() + entityType.getSimpleTypeName() + "Entries";
			}
			return null;
		}
	...
	SAVE (PersistenceCustomDataKeys.PERSIST_METHOD) {
		...
		public String getName(final ServiceAnnotationValues annotationValues, final JavaType entityType, final String plural) {
			if (StringUtils.hasText(annotationValues.getSaveMethod())) {
				return annotationValues.getSaveMethod() + entityType.getSimpleTypeName();
			}
			return null;
		}
	...
	UPDATE (PersistenceCustomDataKeys.MERGE_METHOD) {
		...
		public String getName(final ServiceAnnotationValues annotationValues, final JavaType entityType, final String plural) {
			if (StringUtils.hasText(annotationValues.getUpdateMethod())) {
				return annotationValues.getUpdateMethod() + entityType.getSimpleTypeName();
			}
			return null;
		}
	 ...
	 * @return <code>null</code> if the method is not implemented
	 */
	public JavaSymbolName getSymbolName(final ServiceAnnotationValues annotationValues, final JavaType entityType, final String plural) {
