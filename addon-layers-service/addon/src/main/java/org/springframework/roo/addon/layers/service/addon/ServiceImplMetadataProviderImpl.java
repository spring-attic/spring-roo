...
@Component
@Service
public class ServiceImplMetadataProviderImpl extends
        AbstractMemberDiscoveringItdMetadataProvider implements
        ServiceImplMetadataProvider {
	
	protected final static Logger LOGGER = HandlerUtils.getLogger(ServiceImplMetadataProviderImpl.class);
    ...
    protected void activate(final ComponentContext cContext) {
        ...
        this.keyDecoratorTracker = new CustomDataKeyDecoratorTracker(context, getClass(),
                new LayerTypeMatcher(ROO_SERVICE_IMPL, new JavaSymbolName(
                        RooServiceImpl.SERVICE_ATTRIBUTE)));
    ...
    protected ItdTypeDetailsProvidingMetadataItem getMetadata(
        ...
        final ServiceImplAnnotationValues annotationValues = new ServiceImplAnnotationValues(
