 ...
 * @since 2.0
 */
public class ServiceMetadata extends
        AbstractItdTypeDetailsProvidingMetadataItem {

    private static final String PROVIDES_TYPE_STRING = ServiceMetadata.class
            .getName();
     ...
     */
    public ServiceMetadata(final String identifier,
        ...
        Validate.notNull(entity,
                "ERROR: Entity required to generate service interface");
    ...
    private MethodMetadataBuilder getFindAllMethod(JavaType entity) {
        ...
        MethodMetadataBuilder methodBuilder = new MethodMetadataBuilder(getId(),
                Modifier.PUBLIC + Modifier.ABSTRACT, new JavaSymbolName("findAll"),
    ...
    private MethodMetadataBuilder getFindOneMethod(JavaType entity,
        ...
        // Use the MethodMetadataBuilder for easy creation of MethodMetadata
        MethodMetadataBuilder methodBuilder = new MethodMetadataBuilder(getId(),
                Modifier.PUBLIC + Modifier.ABSTRACT, new JavaSymbolName("findOne"), entity,
    ...
    private MethodMetadataBuilder getSaveMethod(JavaType entity) {
        ...
        // Use the MethodMetadataBuilder for easy creation of MethodMetadata
        MethodMetadataBuilder methodBuilder = new MethodMetadataBuilder(getId(),
                Modifier.PUBLIC + Modifier.ABSTRACT, new JavaSymbolName("save"), entity,
                parameterTypes, parameterNames, null);
    ...
    private MethodMetadataBuilder getDeleteMethod(JavaType identifierType) {
        ...
        // Use the MethodMetadataBuilder for easy creation of MethodMetadata
        MethodMetadataBuilder methodBuilder = new MethodMetadataBuilder(getId(),
                Modifier.PUBLIC + Modifier.ABSTRACT, new JavaSymbolName("delete"),
    ...
    private MethodMetadataBuilder getSaveBatchMethod(JavaType entity) {
        ...
        // Use the MethodMetadataBuilder for easy creation of MethodMetadata
        MethodMetadataBuilder methodBuilder = new MethodMetadataBuilder(getId(),
                Modifier.PUBLIC + Modifier.ABSTRACT, new JavaSymbolName("save"), listEntityJavaType,
                parameterTypes, parameterNames, null);
