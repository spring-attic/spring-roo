...
@Component
@Service
public class ServiceMetadataProviderImpl extends
    ...
    protected String getGovernorPhysicalTypeIdentifier(
        ...
        final JavaType javaType = ServiceMetadata
                .getJavaType(metadataIdentificationString);
        final LogicalPath path = ServiceMetadata
    ...
    protected ItdTypeDetailsProvidingMetadataItem getMetadata(
        ...
        AnnotationMetadata entityAnnotation = entityDetails
                .getAnnotation(RooJavaType.ROO_JPA_ENTITY);
        Validate.notNull(entityAnnotation,
                "ERROR: You should specify an entity annotated with @RooJpaEntity on @RooService annotation");

        // Check if readOnly
        AnnotationAttributeValue<Boolean> readOnlyAttribute = entityAnnotation
