...
public class JsonAnnotationValues extends AbstractAnnotationValues {
  ...
  @AutoPopulate
  String fromJsonArrayMethod = "fromJsonArrayTo<TypeNamePlural>";
  @AutoPopulate
  String fromJsonMethod = "fromJsonTo<TypeName>";
  @AutoPopulate
  String rootName = "";
  @AutoPopulate
  String toJsonArrayMethod = "toJsonArray";
  @AutoPopulate
  String toJsonMethod = "toJson";
