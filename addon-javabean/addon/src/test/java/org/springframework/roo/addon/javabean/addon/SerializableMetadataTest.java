...
public class SerializableMetadataTest {
  ...
  private static final String METADATA_ID =
      "MID:org.springframework.roo.addon.javabean.addon.SerializableMetadata#SRC_MAIN_JAVA?com.example.Person";

  @Mock
  private JavaType mockAspectName;
  // Fixture
  @Mock
  private ClassOrInterfaceTypeDetails mockClassDetails;
  @Mock
  private PhysicalTypeMetadata mockGovernor;
  @Mock
  private JavaPackage mockPackage;
  @Mock
  private JavaType mockTargetType;
  ...
  private void assertItdContents(final boolean alreadySerializable,
    ...
    when(mockClassDetails.declaresField(SerializableMetadata.SERIAL_VERSION_FIELD)).thenReturn(
        alreadyHasVersionField);
    final SerializableMetadata metadata =
        new SerializableMetadata(METADATA_ID, mockAspectName, mockGovernor);
