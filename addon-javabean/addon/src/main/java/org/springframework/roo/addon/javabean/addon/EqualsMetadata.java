...
public class EqualsMetadata extends AbstractItdTypeDetailsProvidingMetadataItem {
  ...
  private MethodMetadataBuilder getEqualsMethod() {
    ...
    return new MethodMetadataBuilder(getId(), Modifier.PUBLIC, EQUALS_METHOD_NAME,
        BOOLEAN_PRIMITIVE, AnnotatedJavaType.convertFromJavaTypes(parameterType), parameterNames,
        bodyBuilder);
  }
  ...
  private MethodMetadataBuilder getHashCodeMethod() {
    ...
    return new MethodMetadataBuilder(getId(), Modifier.PUBLIC, HASH_CODE_METHOD_NAME,
