...
public class JAXRSApplication {
    ...
    public JAXRSApplication(BundleContext bundleContext, String cpath) {
        ...
        this.resourceConfig = new ResourceConfig().register(
     ...
     */
    public HttpService addHttpService(HttpService service)
        ...
        if (this.httpService == null) {
            ...
            this.httpService.registerServlet(this.contextPath,
                    servletContainer, null, null);
