...
This appendix was automatically built from Roo 2.0.0.M1 [rev
cd16e63].
...
offers Roo shell as link:#install-roo-support[extension plugin]. 
...
[[install-roo-support]]
==== Install the Roo STS plugin

To install the Roo STS plugin go to Spring Roo project page 
http://projects.spring.io/spring-roo/#install-roo-sts
