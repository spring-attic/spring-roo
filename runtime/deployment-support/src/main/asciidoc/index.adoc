...
////
The site not only provides the download itself, but also provides access
to all historically released versions plus SHA1 hash codes of those files.
...
Web: http://stackoverflow.com/questions/tagged/spring-roo

For fast and free end user support for all official Spring projects, the
Spring Roo Forum is an excellent place to visit. Because Roo is an
