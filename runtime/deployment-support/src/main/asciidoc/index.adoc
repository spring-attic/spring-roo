...
:numbered:
:sectnumlevels:		5
:icon:			"./images/xdev-sring_logo.jpg"
...
@Component  // <1> 
@Service  // <1>
public class BatchCommands implements CommandMarker {  // <2>

    @Reference private BatchOperations operations;  // <3>
    @Reference private StaticFieldConverter staticFieldConverter;

    protected void activate(ComponentContext context) {  // <4>
       staticFieldConverter.add(BatchPropertyName.class);
    }

    protected void deactivate(ComponentContext context) {  // <4>
       staticFieldConverter.remove(BatchPropertyName.class);
    }

    @CliAvailabilityIndicator("welcome property")  // <5>
    public boolean isPropertyAvailable() {
       return operations.isProjectAvailable();  
    }

    @CliCommand(value="welcome property", help="Obtains a pre-defined system property")  // <6>
    public String property(@CliOption  // <7>
	(key="name", mandatory=false, specifiedDefaultValue="USERNAME", unspecifiedDefaultValue="USERNAME", help="The property name you'd like to display") BatchPropertyName propertyName) {  
