...
To install Spring Roo on your STS 3.8.0+ follow the instructions below:

. Go to link:https://spring.io/tools/sts/all[Spring Tool Suite™ Downloads] and follow the instructions to install the STS.
. Open your STS IDE.
...
. Open "Window > Preferences > Spring > Roo Support".
. In "Roo Support" press "Add" new installation button.
. In "Roo Configure Roo Installation" press "Browse" button, then select the the directory in which Spring Roo 2.0.0 was unpacked.
+
[align="center"]
