...
public class JavaPackageConverterTest {
  ...
  private void assertConvertFromValidText(final String text, final String optionContext,
    ...
    assertEquals(expectedPackage, converter.convertFromText(text, JavaPackage.class, optionContext)
  ...
  private void assertGetAllPossibleValues(final boolean projectAvailable,
    ...
    final boolean allComplete =
        converter.getAllPossibleValues(completions, JavaPackage.class, null, null, null);
  ...
  public void testGetAllPossibleValuesWhenProjectIsAvailable() {
    ...
    final Pom mockPom2 =
        setUpMockPom("/path/to/pom/2", new JavaType("com.example.web.ChoiceController"),
            new JavaType("com.example.web.VoteController"));
