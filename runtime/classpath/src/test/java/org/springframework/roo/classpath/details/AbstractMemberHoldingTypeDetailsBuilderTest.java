...
public class AbstractMemberHoldingTypeDetailsBuilderTest {
   ...
   * classes
   */
  private static class TestableBuilder extends
  ...
  public void testAddExtendsTypeAfterSettingUnmodifiableCollection() {
    ...
    // Check
    assertTrue(added);
    assertEquals(Arrays.asList(mockType1, mockType2), builder.getExtendsTypes());
  }
  ...
  public void testAddFieldAfterSettingUnmodifiableCollection() {
    ...
    // Check
    assertTrue(added);
    assertEquals(Arrays.asList(mockField1, mockField2), builder.getDeclaredFields());
  }
  ...
  public void testAddImplementsTypeAfterSettingUnmodifiableCollection() {
    ...
    // Check
    assertTrue(added);
    assertEquals(Arrays.asList(mockType1, mockType2), builder.getImplementsTypes());
  }
  ...
  public void testAddInnerTypeAfterSettingUnmodifiableCollection() {
    // Set up
    final ClassOrInterfaceTypeDetailsBuilder mockInnerType1 =
        mock(ClassOrInterfaceTypeDetailsBuilder.class);
    final ClassOrInterfaceTypeDetailsBuilder mockInnerType2 =
        mock(ClassOrInterfaceTypeDetailsBuilder.class);
    ...
    // Check
    assertTrue(added);
    assertEquals(Arrays.asList(mockInnerType1, mockInnerType2), builder.getDeclaredInnerTypes());
  }
}
