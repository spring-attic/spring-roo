 ...
 */
public class ItdTriggerBasedMetadataProviderTracker
        extends
     ...
     */
    public ItdTriggerBasedMetadataProviderTracker(BundleContext bc,
            Class<? extends ItdTriggerBasedMetadataProvider> clazz,
            JavaType javaType) {
    ...
    public ItdTriggerBasedMetadataProvider addingService(
        ...
        ItdTriggerBasedMetadataProvider metadataProvider = super
                .addingService(ref);
