...
public class DeclaredFieldAnnotationDetails {
   ...
   */
  public DeclaredFieldAnnotationDetails(final FieldMetadata field,
      final AnnotationMetadata fieldAnnotation, final boolean removeAnnotation) {
    ...
    if (removeAnnotation) {
      Validate
          .isTrue(
              ...
              fieldAnnotation.getAnnotationType().getSimpleTypeName(), field.getFieldType()
                  .getFullyQualifiedTypeName(), field.getFieldName().getSymbolName());
    }
    this.field = field;
