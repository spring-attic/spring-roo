...
public class MemberTypeAdditions {
   ...
   */
  static String buildMethodCall(final String targetName, final String methodName,
   ...
   *            (required)
   */
  public static MemberTypeAdditions getInstance(final ClassOrInterfaceTypeDetailsBuilder builder,
      final String targetName, final String methodName, final boolean isStatic,
      final List<MethodParameter> parameters) {
    return new MemberTypeAdditions(builder, methodName, buildMethodCall(targetName, methodName,
   ...
   *            be <code>null</code>)
   */
  public MemberTypeAdditions(final ClassOrInterfaceTypeDetailsBuilder builder,
      final String methodName, final String methodCall, final boolean isStatic,
      final List<MethodParameter> methodParameters) {
    Validate.notBlank(methodName, "Invalid method name '%s'", methodName);
    Validate.notBlank(methodCall, "Invalid method signature '%s'", methodCall);
  ...
  public void copyAdditionsTo(final AbstractMemberHoldingTypeDetailsBuilder<?> targetBuilder,
    ...
    if (classOrInterfaceDetailsBuilder != null) {
      classOrInterfaceDetailsBuilder.copyTo(targetBuilder, governorClassOrInterfaceTypeDetails);
    }
  }
  ...
  public FieldMetadata getInvokedField() {
    ...
    final List<FieldMetadataBuilder> declaredFields =
        classOrInterfaceDetailsBuilder.getDeclaredFields();
  ...
  public String toString() {
    ...
    builder.append("classOrInterfaceDetailsBuilder", classOrInterfaceDetailsBuilder);
