...
public abstract class AutoPopulationUtils {
  private static final Map<Field, JavaSymbolName> attributeNameForEachField =
      new HashMap<Field, JavaSymbolName>();
  private static final Map<Class<?>, List<Field>> cachedIntrospections =
      ...
      if (annotation.getAttributeNames().contains(attributeName)) {
        ...
        try {
          ...
          if (value instanceof BooleanAttributeValue
              && (fieldType.equals(Boolean.class) || fieldType.equals(Boolean.TYPE))) {
            field.set(target, value.getValue());
          } else if (value instanceof CharAttributeValue
              && (fieldType.equals(Character.class) || fieldType.equals(Character.TYPE))) {
            field.set(target, value.getValue());
            ...
            field.set(target, value.getValue());
          } else if (value instanceof StringAttributeValue && fieldType.getComponentType() != null
            ...
            for (final AnnotationAttributeValue<?> val : castValue.getValue()) {
              ...
              if (fieldType.getComponentType().equals(String.class)
              ...
              } else if (fieldType.getComponentType().equals(JavaType.class)
