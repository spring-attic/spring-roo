...
public class GAVConverterTest {
   ...
   */
  private void assertPossibleValues(final String existingData, final boolean expectedComplete,
    ...
    final boolean complete =
        converter.getAllPossibleValues(completions, null, existingData, null, null);
  ...
  public void testConvertFromValidCoordinates() {
    ...
    final String coordinates =
        StringUtils.join(Arrays.asList(groupId, artifactId, version),
