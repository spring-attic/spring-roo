...
public class MetadataDependencyRegistryTracker extends
    ...
    public MetadataDependencyRegistryTracker(BundleContext bc,
            MetadataNotificationListener notificationListener,
            String upstreamDependency, String downstreamDependency) {
        this(bc, notificationListener, new MetadataDependency(
    ...
    public MetadataDependencyRegistryTracker(BundleContext bc,
            MetadataNotificationListener notificationListener,
            MetadataDependency... dependencies) {
     ...
     */
    @Override
    public MetadataDependencyRegistry addingService(
            ServiceReference<MetadataDependencyRegistry> ref) {
    ...
    public void modifiedService(
            ServiceReference<MetadataDependencyRegistry> reference,
        ...
        if (this.dependencies != null) {
            for (MetadataDependency dependency : this.dependencies) {
                registry.deregisterDependency(
                        dependency.getUpstreamDependency(),
                        dependency.getDownstreamDependency());
            }
        }
