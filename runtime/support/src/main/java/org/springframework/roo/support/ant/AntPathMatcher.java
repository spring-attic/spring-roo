...
public class AntPathMatcher implements PathMatcher {
  ...
  protected boolean doMatch(final String pattern, final String path, final boolean fullMatch,
    ...
    final String[] patternDirs =
        new StrTokenizer(pattern, pathSeparator).setIgnoreEmptyTokens(true).getTokenArray();
    final String[] pathDirs =
        new StrTokenizer(path, pathSeparator).setIgnoreEmptyTokens(true).getTokenArray();
  ...
  private boolean matchStrings(final String pattern, final String str,
      final Map<String, String> uriTemplateVariables) {
    final AntPatchStringMatcher matcher =
        new AntPatchStringMatcher(pattern, str, uriTemplateVariables);
