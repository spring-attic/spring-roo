...
public class NewUpdateCompilationUnitTest {
  ...
  private static final JavaType SIMPLE_CLASS_TYPE = new JavaType("org.myPackage.SimpleClass");
  private static final JavaType SIMPLE_CLASS2_TYPE = new JavaType("org.myPackage.SimpleClass2");
  private static final JavaType SIMPLE_CLASS3_TYPE = new JavaType("org.myPackage.SimpleClass3");
  private static final JavaType ROO1505_CLASS_TYPE = new JavaType("com.pet.Roo_1505");
  private static final JavaType ENUM_TYPE = new JavaType("org.myPackage.AEnumerate");

  private static final String SIMPLE_INTERFACE_DECLARED_BY_MID =
      "MID:org.springframework.roo.classpath.PhysicalTypeIdentifier#bar?SimpleInterface";
  private static final String SIMPLE_CLASS_DECLARED_BY_MID =
      "MID:org.springframework.roo.classpath.PhysicalTypeIdentifier#SRC_MAIN_JAVA?SimpleClass";
  private static final String SIMPLE_CLASS2_DECLARED_BY_MID =
      "MID:org.springframework.roo.classpath.PhysicalTypeIdentifier#SRC_MAIN_JAVA?SimpleClass2";
  private static final String SIMPLE_CLASS3_DECLARED_BY_MID =
      "MID:org.springframework.roo.classpath.PhysicalTypeIdentifier#SRC_MAIN_JAVA?SimpleClass3";
  private static final String ROO1505_CLASS_DECLARED_BY_MID =
      "MID:org.springframework.roo.classpath.PhysicalTypeIdentifier#SRC_MAIN_JAVA?Roo_1505";
  private static final String ENUM_DECLARED_BY_MID =
      "MID:org.springframework.roo.classpath.PhysicalTypeIdentifier#SRC_MAIN_JAVA?AEnumerate";
  ...
  public void testSimpleInterfaceNoChanges() throws Exception {
    ...
    final ClassOrInterfaceTypeDetails simpleInterfaceDetails =
        typeParsingService.getTypeFromString(fileContents, SIMPLE_INTERFACE_DECLARED_BY_MID,
            SIMPLE_INTERFACE_TYPE);

    // Invoke
    final String result =
        typeParsingService.updateAndGetCompilationUnitContents(file.getCanonicalPath(),
  ...
  public void testEnumNoChanges() throws Exception {
    ...
    final ClassOrInterfaceTypeDetails simpleInterfaceDetails2 =
        typeParsingService.getTypeFromString(result, ENUM_DECLARED_BY_MID, ENUM_TYPE);
  ...
  public void testSimpleInterfaceVoidFile() throws Exception {
    ...
    // Invoke
    final String result =
        typeParsingService.updateAndGetCompilationUnitContents(voidFile.getCanonicalPath(),
            simpleInterfaceDetails);
  ...
  public void testSimpleClassNoChanges() throws Exception {
    ...
    final ClassOrInterfaceTypeDetails simpleInterfaceDetails =
        typeParsingService.getTypeFromString(fileContents, SIMPLE_CLASS_DECLARED_BY_MID,
            SIMPLE_CLASS_TYPE);
  ...
  public void testSimpleClass2NoChanges() throws Exception {
    ...
    final ClassOrInterfaceTypeDetails simpleInterfaceDetails =
        typeParsingService.getTypeFromString(fileContents, SIMPLE_CLASS2_DECLARED_BY_MID,
            SIMPLE_CLASS2_TYPE);

    // Invoke
    final String result =
        typeParsingService.updateAndGetCompilationUnitContents(file.getAbsolutePath(),
            simpleInterfaceDetails);
  ...
  public void testSimpleClass3NoChanges() throws Exception {
    ...
    final ClassOrInterfaceTypeDetails simpleInterfaceDetails =
        typeParsingService.getTypeFromString(fileContents, SIMPLE_CLASS3_DECLARED_BY_MID,
            SIMPLE_CLASS3_TYPE);
  ...
  public void testRegresion_ROO_1505() throws Exception {
    ...
    final ClassOrInterfaceTypeDetails simpleInterfaceDetails =
        typeParsingService.getTypeFromString(fileContents, ROO1505_CLASS_DECLARED_BY_MID,
            ROO1505_CLASS_TYPE);
  ...
  public void testSimpleClassAddField() throws Exception {
    ...
    final FieldMetadataBuilder fieldBuilder =
        new FieldMetadataBuilder(SIMPLE_CLASS_DECLARED_BY_MID, Modifier.PRIVATE,
            new JavaSymbolName("newFieldAddedByCode"), new JavaType(String.class),
            "\"Create by code\"");
  ...
  public void testSimpleClassAddAnnotation() throws Exception {
    ...
    // Invoke again
    final ClassOrInterfaceTypeDetails simpleInterfaceDetails2 =
        typeParsingService.getTypeFromString(result, SIMPLE_CLASS_DECLARED_BY_MID,
            SIMPLE_CLASS_TYPE);
  ...
  public static ClassOrInterfaceTypeDetails addField(final ClassOrInterfaceTypeDetails ptd,
  ...
  public static ClassOrInterfaceTypeDetails addAnnotation(final ClassOrInterfaceTypeDetails ptd,
  ...
  public static void checkSimpleClass(final String result) {
    ...
    assertTrue(result.contains("import static test.importtest.pkg.Hola.proofMethod;"));
    ...
    assertTrue(result.contains("private List<String>[] listArray = new List<String>[3];"));
    assertTrue(result.contains("Set<String>[] setArray = new Set<String>[] { null, null, null };"));
    ...
    assertTrue(result.contains("@Deprecated(message = \"Do not use\", more = \"Nothing\")"));
    ...
    assertTrue(result.contains("for (Map<String, Object> map : mapArrayParam)"));
    ...
    assertTrue(result.contains("else if (theNumbers.tres.equals(enumValue))"));
  ...
  public static void checkSimple2Class(final String result) {
    ...
    assertTrue(result.contains("List<SimpleClass2> result = new ArrayList<SimpleClass2>();"));
  ...
  public static void checkSimple3Class(final String result) {
    ...
    assertTrue(result.contains("Map<String, Double>[] mMapStringDoubleArray;"));
    assertTrue(result.contains("Map<String, Double>[][] mMapStringDoubleArray2;"));
    assertTrue(result.contains("Map<String, Double>[][][] mMapStringDoubleArray3;"));

    // Check Map of Strings and Doubles
    assertTrue(result.contains("List<Map<String, Iterator<Double>>> mListMapStringIteratorDouble;"));
    assertTrue(result
  ...
  public static void check_ROO_1505_Class(final String result) {
    ...
    assertTrue(result.contains("import org.springframework.roo.addon.javabean.addon.RooJavaBean;"));
    assertTrue(result.contains("import org.springframework.roo.addon.javabean.addon.RooToString;"));
    assertTrue(result.contains("import org.springframework.roo.addon.entity.RooEntity;"));
    assertTrue(result.contains("import javax.validation.constraints.NotNull;"));
    ...
    assertTrue(result.contains("@OneToMany(cascade = CascadeType.ALL, mappedBy = \"owner\")"));
    assertTrue(result.contains("private Set<Pet> pets = new HashSet();"));
  }

  public static void checkSimpleInterface(final String result, final boolean testComments) {
    if (testComments) {
      assertTrue(result.contains("* File header"));
    }
    assertTrue(result.contains("package org.myPackage;"));
    ...
    assertTrue(result.contains("extends Comparable<SimpleInterface>, Iterable<SimpleInterface>"));
    if (testComments) {
      assertTrue(result.contains("* Javadoc of hello method"));
    }
  ...
  private void saveResult(final File orgininalFile, final String result, String suffix)
    ...
    final File resultFile =
        new File(orgininalFile.getParentFile(), FilenameUtils.getName(orgininalFile.getName())
            + suffix);
    FileUtils.write(resultFile, result);
  }

  private void saveResult(final File orgininalFile, final String result) throws IOException {
