...
public class Activator implements BundleActivator {
  ...
  private String getClassName(final ServiceReference sr, final BundleContext context) {
    ...
    if (sr.getProperty("component.name") != null) {
      ...
      final String componentName = sr.getProperty("component.name").toString();
  ...
  public void process(final URL url) {
    ...
    final NodeList components = rootElement.getElementsByTagName("scr:component");
    ...
    for (int i = 0; i < components.getLength(); i++) {
      ...
      final NodeList implementation = component.getElementsByTagName("implementation");
