...
@Component
@Service
public class ObrAddonSuiteSymbolicNameConverter implements
        Converter<ObrAddonSuiteSymbolicName> {
    ...
    public ObrAddonSuiteSymbolicName convertFromText(final String value,
