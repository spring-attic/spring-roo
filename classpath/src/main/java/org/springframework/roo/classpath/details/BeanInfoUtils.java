...
public final class BeanInfoUtils {
	 ...
	 *
	 * @param method to search (required, and must be a "get", "set" or "is" method)
	...
	public static JavaSymbolName getPropertyNameForJavaBeanMethod(final MethodMetadata method) {
		...
		String name = method.getMethodName().getSymbolName();
	 ...
	 */
	public static FieldMetadata getFieldForPropertyName(final MemberDetails memberDetails, final JavaSymbolName propertyName) {
	 ...
	 * @return the field if found, or null if it could not be found
	 */
	public static FieldMetadata getFieldForJavaBeanMethod(final MemberDetails memberDetails, final MethodMetadata method) {
		Assert.notNull(memberDetails, "Member details required");
		Assert.notNull(method, "Method is required");
		JavaSymbolName propertyName = getPropertyNameForJavaBeanMethod(method);
	 ...
	 */
	public static boolean hasAccessorAndMutator(final FieldMetadata field, final MemberDetails memberDetails) {
