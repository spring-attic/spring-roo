 ...
 * 
 * <p>
 * Sub-interfaces are created for different major Java types, such as those specific to
 * classes, enums, and annotations. This allows sub-interfaces to provide accessors applicable
 * to the specific category of Java type.
 * 
 * @author Ben Alex
 * @since 1.0
 */
public interface PhysicalTypeDetails extends CustomDataAccessor {
	 ...
	 * 
	 * @return the full name of the type that members will eventually be available from when compiled, including any 
