...
public interface TriggerBasedMetadataProvider extends MetadataProvider {
	...
	/**
	 * Causes this provider to generate metadata if the given annotation is present.
	 * 
	...
	/**
	 * Stops this provider generating metadata if the given annotation is present.
	 * 
