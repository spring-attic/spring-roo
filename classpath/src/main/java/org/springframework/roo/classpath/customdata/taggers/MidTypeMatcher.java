...
public class MidTypeMatcher extends TypeMatcher{
	 ...
	 * @since 1.2
	 */
	public MidTypeMatcher(final CustomDataKey<MemberHoldingTypeDetails> customDataKey, final Class<?> declaredBy) {
	 ...
	 */
	public MidTypeMatcher(final CustomDataKey<MemberHoldingTypeDetails> customDataKey, final String declaredBy) {
