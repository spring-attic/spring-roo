...
public interface PreferencesService {
	...
	/**
	 * Returns the user's preferences for the package in which the given class resides.
	 * 
	 * @param owningClass the class for whose package to retrieve the user's preferences (required)
