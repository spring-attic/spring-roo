 ...
 */
public interface PhysicalTypeMetadata extends MemberHoldingTypeDetailsMetadataItem<ClassOrInterfaceTypeDetails> {
	 ...
	 * @deprecated use {@link #getItdCanonicalPath(ItdMetadataProvider)} instead (fixes typo)
	 */
	@Deprecated
	 ...
	 * Obtains the canonical file path to where an ITD can be emitted for this physical Java type.
	 *
	 * @param metadataProvider the {@link MetadataProvider} that produces the ITD in question (never null)
	 * @return a full file path that can be used to produce an ITD (never null)
	 * @since 1.2.0
	 */
