...
/**
 * Allows an identifiable Java structure (ie a member or a type) to be traced back to its declaring type.
 * 
 * @author Ben Alex
 * @since 1.0
 *
...
public interface IdentifiableJavaStructure extends CustomDataAccessor {
	 ...
	 * {@link Modifier}. Returning 0 is acceptable the less common structures that don't support
	 * modifiers (eg static initializers).
	 * 
