...
public class FieldCommands implements CommandMarker {
	...
	public void addFieldReferenceJpa(
		...
		@CliOption(key = "cardinality", mandatory = false, unspecifiedDefaultValue = "MANY_TO_ONE", specifiedDefaultValue = "MANY_TO_ONE", help = "The relationship cardinality at a JPA level") Cardinality cardinality, 
