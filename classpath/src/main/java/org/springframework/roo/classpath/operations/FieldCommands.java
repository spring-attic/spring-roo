...
public class FieldCommands implements CommandMarker {
    ...
    public void insertField(
        ...
        ClassOrInterfaceTypeDetails javaTypeDetails = typeLocationService
                .getTypeDetails(typeName);
        Assert.notNull(javaTypeDetails, "The type specified, '" + typeName
                + "'doesn't exist");

        String physicalTypeIdentifier = javaTypeDetails
    ...
    public void addFieldNumber(
        ...
        String physicalTypeIdentifier = javaTypeDetails
                .getDeclaredByMetadataId();
        if (primitive
                && this.legalNumericPrimitives.contains(fieldType
                        .getFullyQualifiedTypeName())) {
            fieldType = new JavaType(fieldType.getFullyQualifiedTypeName(), 0,
                    DataType.PRIMITIVE, null, null);
        }
        NumericField fieldDetails = new NumericField(physicalTypeIdentifier,
                fieldType, fieldName);
        fieldDetails.setNotNull(notNull);
        fieldDetails.setNullRequired(nullRequired);
        if (decimalMin != null)
    ...
    public void addFieldString(
        ...
        String physicalTypeIdentifier = javaTypeDetails
                .getDeclaredByMetadataId();
        StringField fieldDetails = new StringField(physicalTypeIdentifier,
                fieldName);
        fieldDetails.setNotNull(notNull);
        fieldDetails.setNullRequired(nullRequired);
        if (decimalMin != null)
    ...
    public void addFieldDateJpa(
        ...
        String physicalTypeIdentifier = javaTypeDetails
                .getDeclaredByMetadataId();
        DateField fieldDetails = new DateField(physicalTypeIdentifier,
                fieldType, fieldName);
        fieldDetails.setNotNull(notNull);
        fieldDetails.setNullRequired(nullRequired);
    ...
    public void addFieldBoolean(
        ...
        String physicalTypeIdentifier = javaTypeDetails
                .getDeclaredByMetadataId();
        BooleanField fieldDetails = new BooleanField(physicalTypeIdentifier,
                primitive ? JavaType.BOOLEAN_PRIMITIVE
    ...
    public void addFieldReferenceJpa(
        ...
        String physicalTypeIdentifier = javaTypeDetails
                .getDeclaredByMetadataId();
        ReferenceField fieldDetails = new ReferenceField(
    ...
    public void addFieldSetJpa(
        ...
        String physicalTypeIdentifier = javaTypeDetails
                .getDeclaredByMetadataId();
        SetField fieldDetails = new SetField(physicalTypeIdentifier,
    ...
    public void addFieldEnum(
        ...
        EnumField fieldDetails = new EnumField(physicalTypeIdentifier,
                fieldType, fieldName);
        if (column != null)
            fieldDetails.setColumn(column);
        fieldDetails.setNotNull(notNull);
    ...
    public void addFieldEmbeddedJpa(
        ...
        String physicalTypeIdentifier = javaTypeDetails
                .getDeclaredByMetadataId();
        PhysicalTypeMetadata targetTypeMetadata = (PhysicalTypeMetadata) metadataService
                .get(physicalTypeIdentifier);
        Assert.notNull(
                targetTypeMetadata,
                "The specified target '--class' does not exist or can not be found. Please create this type first.");
        PhysicalTypeDetails targetPtd = targetTypeMetadata
        ...
        MemberDetails memberDetails = memberDetailsScanner.getMemberDetails(
                this.getClass().getName(), targetTypeCid);
        Assert.isTrue(
        ...
        EmbeddedField fieldDetails = new EmbeddedField(physicalTypeIdentifier,
                fieldType, fieldName);
    ...
    public void addFileUploadField(
        ...
        String physicalTypeIdentifier = cid.getDeclaredByMetadataId();
        UploadedFileField fieldDetails = new UploadedFileField(
