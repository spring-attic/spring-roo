...
public interface TypeParsingService {
	...
	/**
	 * Builds a {@link ClassOrInterfaceTypeDetails} object that represents the requested {@link org.springframework.roo.model.JavaType}
	 * from the type at the passed in type path.
	 *
	 ...
	 */
	ClassOrInterfaceTypeDetails getTypeAtLocation(String fileIdentifier, String declaredByMetadataId, JavaType javaType);
	 ...
	 * @return a parsed representation of the requested type from the passed compilation unit (never null)
	 */
	ClassOrInterfaceTypeDetails getTypeFromString(String typeContents, String declaredByMetadataId, JavaType javaType);
	 ...
	 * representation to be emitted to disk via {@link TypeManagementService}. One concrete
