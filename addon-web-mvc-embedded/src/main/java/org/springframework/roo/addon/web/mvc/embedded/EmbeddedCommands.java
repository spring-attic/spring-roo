...
public class EmbeddedCommands implements CommandMarker {
  ...
  @Reference
  private EmbeddedOperations embeddedOperations;
  @Reference
  ...
  @CliCommand(value = "web mvc embed generic",
      help = "Embed media by URL into your WEB MVC application")
  public void embed(@CliOption(key = "url", mandatory = true,
      help = "The url of the source to be embedded") final String url, @CliOption(key = "viewName",
      mandatory = false, help = "The name of the jspx view") final String viewName) {

    embeddedOperations.embed(url, viewName);
  }

  @CliCommand(value = "web mvc embed document",
      help = "Embed a document for your WEB MVC application")
  ...
  public void embedMap(
      @CliOption(key = "location", mandatory = true,
          help = "The location of the map (ie \"Sydney, Australia\")") final String location,
      @CliOption(key = "viewName", mandatory = false, help = "The name of the jspx view") final String viewName) {
  ...
  @CliCommand(value = "web mvc embed photos",
      help = "Embed a photo gallery for your WEB MVC application")
  public void embedPhotos(@CliOption(key = "provider", mandatory = true,
      help = "The provider of the photo gallery") final PhotoProvider provider, @CliOption(
      key = "userId", mandatory = true, help = "The user id") final String userId, @CliOption(
      key = "albumId", mandatory = true, help = "The album id") final String albumId, @CliOption(
      key = "viewName", mandatory = false, help = "The name of the jspx view") final String viewName) {
  ...
  @CliCommand(value = "web mvc embed twitter",
      help = "Embed twitter messages into your WEB MVC application")
  public void embedTwitter(@CliOption(key = "searchTerm", mandatory = true,
      help = "The search term to display results for") final String searchTerm, @CliOption(
      key = "viewName", mandatory = false, help = "The name of the jspx view") final String viewName) {
  ...
  public void embedVideo(@CliOption(key = "provider", mandatory = true,
      help = "The id of the video") final VideoProvider provider, @CliOption(key = "videoId",
      mandatory = true, help = "The id of the video") final String id, @CliOption(key = "viewName",
      mandatory = false, help = "The name of the jspx view") final String viewName) {
  ...
  @CliCommand(value = "web mvc embed stream video",
      help = "Embed a video stream into your WEB MVC application")
  ...
  @CliCommand(value = "web mvc embed wave",
      help = "Embed Google wave integration for your WEB MVC application")
  ...
  @CliAvailabilityIndicator({"web mvc embed generic", "web mvc embed wave", "web mvc embed map",
      "web mvc embed document", "web mvc embed video", "web mvc embed photos",
      "web mvc embed stream video", "web mvc embed finances", "web mvc embed twitter"})
