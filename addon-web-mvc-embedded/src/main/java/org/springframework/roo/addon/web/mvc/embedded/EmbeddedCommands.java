...
public class EmbeddedCommands implements CommandMarker {
	...
	public void embedWave(
		@CliOption(key = "waveId", mandatory = true, help = "The key of the wave") String key, 
		@CliOption(key = "viewName", mandatory = false, help = "The name of the jspx view") String viewName) {
	...
	public void embedDocument(
		@CliOption(key = "provider", mandatory = true, help = "The id of the document") DocumentProvider provider, 
	...
	public void embedVideo(
		@CliOption(key = "provider", mandatory = true, help = "The id of the video") VideoProvider provider, 
	...
	public void embedPhotos(
		@CliOption(key = "provider", mandatory = true, help = "The provider of the photo gallery") PhotoProvider provider, 
...
//	}
	...
	public void embedTwitter(
		@CliOption(key = "searchTerm", mandatory = true, help = "The search term to display results for") String searchTerm,
		@CliOption(key="viewName", mandatory=false, help="The name of the jspx view") String viewName) {
