 ...
 * providers by taking advantage of the infrastructure provided by this 
 * addon.
 * 
...
public interface EmbeddedProvider {
	 ...
	 * @return true if this addon can handle the URL offered (otherwise you MUST return false so other addons can provide the implementation for the URL provided)
	 */
	boolean embed(String url, String viewName);
	
	/**
	 * Implement this method to provide alternative (to the generic URL-based approach)
	 * offered by embed method.
	 * 
	 ...
	 * @return true if this addon can handle the options offered (otherwise you MUST return false so other addons can provide the implementation for the options provided)
	 */
