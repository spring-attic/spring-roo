...
public class JavaType implements Comparable<JavaType> {
    ...
    private String getNameIncludingTypeParameters(final boolean staticForm,
        ...
        if (DataType.PRIMITIVE == dataType) {
            ...
            else if (this.fullyQualifiedTypeName.equals(Character.class
                    .getName())) {
    ...
    public JavaPackage getPackage() {
        ...
        if (enclosingType != null) {
            String enclosingTypeFullyQualifiedTypeName = enclosingType
                    .getFullyQualifiedTypeName();
    ...
    public boolean equals(final Object obj) {
        ...
        return obj != null
                ...
                && this.fullyQualifiedTypeName.equals(((JavaType) obj)
                        .getFullyQualifiedTypeName())
                && this.dataType == ((JavaType) obj).getDataType()
                && this.arrayDimensions == ((JavaType) obj).getArray()
                && ((JavaType) obj).getParameters()
                        .containsAll(this.parameters);
    }
    ...
    private JavaType determineEnclosingType() {
        ...
        if (Character.isUpperCase(enclosedWithinTypeName.charAt(0))) {
            ...
            String preTypeNamePortion = enclosedWithinPackage == null ? ""
