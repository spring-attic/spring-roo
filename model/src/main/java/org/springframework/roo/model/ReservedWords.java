...
public final class ReservedWords {
    ...
    public static void verifyReservedSqlKeywordsNotPresent(
            final JavaType javaType) {
        Assert.notNull(javaType, "Java type required");
        if (ReservedWords.RESERVED_SQL_KEYWORDS.contains(javaType
    ...
    public static void verifyReservedJavaKeywordsNotPresent(
        ...
        if (ReservedWords.RESERVED_JAVA_KEYWORDS.contains(javaSymbolName
                .getSymbolName())) {
    ...
    public static void verifyReservedSqlKeywordsNotPresent(
            final JavaSymbolName javaSymbolName) {
        Assert.notNull(javaSymbolName, "Java symbol required");
        if (ReservedWords.RESERVED_SQL_KEYWORDS.contains(javaSymbolName
