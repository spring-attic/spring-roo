...
@Component
@Service
public class PermissionEvaluatorMetadataProvider extends AbstractMemberDiscoveringItdMetadataProvider
{
	@Reference
	...
	{
		final ClassOrInterfaceTypeDetails permissionEvaluatorClass = governorPhysicalTypeMetadata.getMemberHoldingTypeDetails();
		...
		final MemberDetails permissionEvaluatorClassDetails = memberDetailsScanner.getMemberDetails(getClass().getName(), permissionEvaluatorClass);

		return new PermissionEvaluatorMetadata(metadataIdentificationString, aspectName, governorPhysicalTypeMetadata, permissionEvaluatorClassDetails);
	}
}
