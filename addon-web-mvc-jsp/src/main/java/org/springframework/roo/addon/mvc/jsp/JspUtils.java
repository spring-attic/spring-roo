...
public class JspUtils {
	...
	public static Element getInputBox(Document document, JavaSymbolName field, Integer maxValue) {
		...
		formInput.setAttribute("path", Introspector.decapitalize(StringUtils.capitalize(field.getSymbolName())));
	...
	public static Element getSelectBox(Document document, JavaSymbolName fieldName, String pluralName, FieldMetadata identifierField) {
		...
		formSelect.setAttribute("path", Introspector.decapitalize(StringUtils.capitalize(fieldName.getSymbolName())));
	...
	public static Element getTextArea(Document document, JavaSymbolName fieldName, Integer maxValue) {
		...
		textArea.setAttribute("path", Introspector.decapitalize(StringUtils.capitalize(fieldName.getSymbolName())));
	...
	public static Element getCheckBox(Document document, JavaSymbolName fieldName) {
		...
		formCheck.setAttribute("path", Introspector.decapitalize(StringUtils.capitalize(fieldName.getSymbolName())));
	...
	public static Element getErrorsElement(Document document, JavaSymbolName field) {
		...
		errors.setAttribute("path", Introspector.decapitalize(StringUtils.capitalize(field.getSymbolName())));
