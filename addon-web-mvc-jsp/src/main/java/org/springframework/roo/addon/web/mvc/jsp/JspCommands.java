...
public class JspCommands implements CommandMarker {
  ...
  public void installView(
    ...
    LOGGER
        .warning("This command has been deprecated and will be disabled soon! Please use 'web mvc setup' followed by 'web mvc install view' instead.");
  ...
  @Deprecated
  @CliCommand(value = "web mvc install language",
      help = "Install new internationalization bundle for MVC scaffolded UI.")
  public void lang(@CliOption(key = {"", "code"}, mandatory = true,
  ...
  @CliCommand(
      ...
      help = "Create a new manual Controller (ie where you write the methods) - deprecated, use 'web mvc controller' instead")
  ...
  @CliCommand(value = "web mvc setup",
      help = "Setup a basic project structure for a Spring MVC / JSP application")
