...
public interface TilesOperations {
	 ...
	 *
	 * @param folderName the name of the folder under <code>/WEB-INF/views</code>
	 * (specified via the path attribute in {@link WebScaffoldMetadata}; can be
	 ...
	 * 'update', etc) or, if views are nested in sub-folders the name should be
	 * 'owner/list', 'owner/show', etc.; any leading slash is ignored
