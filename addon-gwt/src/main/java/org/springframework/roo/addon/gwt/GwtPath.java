...
public enum GwtPath {
    ...
    SCAFFOLD_REQUEST("/client/scaffold/request", "module/client/scaffold/request/" + GwtPath.templateSelector), //GWT_REQUEST
  ...
  SCAFFOLD_SHARED("/shared/scaffold", "module/shared/scaffold/" + GwtPath.templateSelector), //GWT_SCAFFOLD_UI
    ...
    SCAFFOLD_SERVER("/server/scaffold", "module/server/scaffold/" + GwtPath.templateSelector),
