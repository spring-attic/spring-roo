...
public class GwtFileManagerImpl implements GwtFileManager {
	...
	private void write(final String destFile, final String newContents, final boolean overwrite) {
	...
	public String write(final ClassOrInterfaceTypeDetails typeDetails, final String warning) {
		String destFile = typeLocationService.getPhysicalTypeCanonicalPath(typeDetails.getDeclaredByMetadataId());
		String fileContents = typeParsingService.getCompilationUnitContents(typeDetails);
		fileManager.createOrUpdateTextFileIfRequired(destFile, warning + fileContents, true);
		return fileContents;
	}

	public String write(final ClassOrInterfaceTypeDetails typeDetails, boolean includeWarning) {
		String destFile = typeLocationService.getPhysicalTypeCanonicalPath(typeDetails.getDeclaredByMetadataId());
	...
	public void write(final List<ClassOrInterfaceTypeDetails> typeDetails, final boolean includeWarning) {
