...
public class GwtMetadata extends AbstractMetadataItem {
    ...
    private void buildProxy() {
        ...
        if (governorPhysicalTypeMetadata != null) {
            ...
            typeDetailsBuilder = new ClassOrInterfaceTypeDetailsBuilder(governorTypeDetails);
            destinationMetadataId = typeDetailsBuilder.getDeclaredByMetadataId();
        ...
        /*
           ...
           */
        List<JavaSymbolName> fieldOrderedPropertyNames = new ArrayList<JavaSymbolName>();
        ...
        for (JavaSymbolName propertyName : fieldOrderedPropertyNames) {
            JavaSymbolName methodName = propertyToMethod.get(propertyName);
            MethodMetadata methodMetadata = methodNameToMethod.get(methodName);
    ...
    private TemplateDataDictionary buildDataDictionary(MirrorType destType) {
        ...
        for (MethodMetadata method : proxyDeclaredMethods) {
            //System.out.println("proxyDeclaredMethods|method: " + method);
            //System.out.println("proxyDeclaredMethods|methodName: " + method.getMethodName());
