...
public enum GwtType {
    ...
    PROXY(GwtPath.MANAGED_REQUEST, true, "Proxy", "proxy", null, false, false,
            ...
            null, false, false, true), ACTIVITIES_MAPPER(
            GwtPath.MANAGED_ACTIVITY, true, "ActivitiesMapper",
            "activitiesMapper", "ActivitiesMapper", false, true, false), DETAIL_ACTIVITY(
            GwtPath.MANAGED_ACTIVITY, true, "DetailsActivity",
            "detailsActivity", "DetailsActivity", false, true, false), EDIT_ACTIVITY_WRAPPER(
            GwtPath.MANAGED_ACTIVITY, true, "EditActivityWrapper",
            "editActivityWrapper", "EditActivityWrapper", false, true, false), LIST_ACTIVITY(
            GwtPath.MANAGED_ACTIVITY, true, "ListActivity", "listActivity",
            "ListActivity", false, true, false), LIST_VIEW(GwtPath.MANAGED_UI,
            true, "ListView", "listView", "ListView", true, true, false), MOBILE_LIST_VIEW(
            GwtPath.MANAGED_UI, true, "MobileListView", "mobileListView",
            "MobileListView", false, true, false), DETAILS_VIEW(
            GwtPath.MANAGED_UI, true, "DetailsView", "detailsView",
            "DetailsView", true, true, false), MOBILE_DETAILS_VIEW(
            GwtPath.MANAGED_UI, true, "MobileDetailsView", "mobileDetailsView",
            "MobileDetailsView", true, true, false), EDIT_VIEW(
            GwtPath.MANAGED_UI, true, "EditView", "editView", "EditView", true,
            true, false), MOBILE_EDIT_VIEW(GwtPath.MANAGED_UI, true,
            "MobileEditView", "mobileEditView", "MobileEditView", true, true,
            false), EDIT_RENDERER(GwtPath.MANAGED_UI, true, "ProxyRenderer",
            "renderer", "EditRenderer", false, false, false), SET_EDITOR(
            GwtPath.MANAGED_UI, true, "SetEditor", "setEditor", "SetEditor",
            true, true, false), LIST_EDITOR(GwtPath.MANAGED_UI, true,
            "ListEditor", "listEditor", "ListEditor", true, true, false),
    ...
    APP_ENTITY_TYPES_PROCESSOR(GwtPath.MANAGED_REQUEST, false, "",
            ...
            "requestFactory", "ApplicationRequestFactory", false, false, true), LIST_PLACE_RENDERER(
            GwtPath.MANAGED_UI, false, "", "listPlaceRenderer",
            "ApplicationListPlaceRenderer", false, true, false), SCAFFOLD_APP(
            GwtPath.SCAFFOLD, false, "", "scaffoldApp", "ScaffoldApp", false,
            false, false), SCAFFOLD_MOBILE_APP(GwtPath.SCAFFOLD, false, "",
            "scaffoldMobileApp", "ScaffoldMobileApp", false, false, false), IS_SCAFFOLD_MOBILE_ACTIVITY(
            GwtPath.SCAFFOLD_ACTIVITY, false, "", "isScaffoldMobileActivity",
            "IsScaffoldMobileActivity", false, false, false), MOBILE_PROXY_LIST_VIEW(
            GwtPath.SCAFFOLD_UI, false, "", "mobileProxyListView",
            "MobileProxyListView", false, false, false), MASTER_ACTIVITIES(
            GwtPath.MANAGED_ACTIVITY, false, "", "masterActivities",
            "ApplicationMasterActivities", false, true, false), DETAILS_ACTIVITIES(
            GwtPath.MANAGED_ACTIVITY, false, "", "detailsActivities",
            "ApplicationDetailsActivities", false, true, false), MOBILE_ACTIVITIES(
            GwtPath.MANAGED_ACTIVITY, false, "", "mobileActivities",
            "ScaffoldMobileActivities", false, false, false);
