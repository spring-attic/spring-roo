...
import static com.tvt.roo.gwt.GwtJavaType.ACCEPTS_ONE_WIDGET;
import static com.tvt.roo.gwt.GwtJavaType.ENTITY_PROXY;
import static com.tvt.roo.gwt.GwtJavaType.EVENT_BUS;
import static com.tvt.roo.gwt.GwtJavaType.PLACE;
import static com.tvt.roo.gwt.GwtJavaType.RECEIVER;
...
public enum GwtType
{
	...
	DETAILS_VIEW_IMPL(GwtPath.MANAGED_UI_IMPL, true, "DetailsViewImpl", "detailsViewImpl", "DetailsViewImpl", true, true, false),
	...
	EDIT_VIEW_IMPL(GwtPath.MANAGED_UI_IMPL, true, "EditViewImpl", "editViewImpl", "EditViewImpl", true, true, false),
	...
	LIST_VIEW_IMPL(GwtPath.MANAGED_UI_IMPL, true, "ListViewImpl", "listViewImpl", "ListViewImpl", true, true, false),
	...
	MOBILE_DETAILS_VIEW(GwtPath.MANAGED_UI_MOBILE, true, "MobileDetailsView", "mobileDetailsView", "MobileDetailsView", true, true, false),
	MOBILE_EDIT_VIEW(GwtPath.MANAGED_UI_MOBILE, true, "MobileEditView", "mobileEditView", "MobileEditView", true, true, false),
	MOBILE_LIST_VIEW(GwtPath.MANAGED_UI_MOBILE, true, "MobileListView", "mobileListView", "MobileListView", false, true, false),
	...
	private GwtType(final GwtPath path, final boolean mirrorType, final String suffix, final String name, final String template, final boolean createUiXml, final boolean createAbstract,
		...
		case EDIT_VIEW_IMPL:
			for (final GwtProxyProperty property : proxyFieldTypeMap.values())
			{
				if (property.isEnum() || property.isProxy() || property.isEmbeddable() || property.isCollectionOfProxy())
				{
					...
					final JavaType param = new JavaType(COLLECTION.getFullyQualifiedTypeName(), 0, DataType.TYPE, null, Collections.singletonList(property.getValueType()));
					params.add(param);
	...
	private List<GwtType> resolveReferences(final GwtType type)
	{
		...
		case EDIT_ACTIVITY:
			return Arrays.asList(GwtType.EDIT_VIEW, GwtType.APP_REQUEST_FACTORY, GwtType.REQUEST);
		case EDIT_ACTIVITY_WRAPPER:
			return Arrays.asList(GwtType.APP_REQUEST_FACTORY, GwtType.IS_SCAFFOLD_MOBILE_ACTIVITY, GwtType.EDIT_VIEW);
		case LIST_ACTIVITY:
	...
	public List<JavaSymbolName> resolveWatchedFieldNames(final GwtType type)
	{
		...
		{
		case ACTIVITIES_MAPPER:
			watchedFieldNames = convertToJavaSymbolNames("factory", "placeController");
			break;
		case EDIT_ACTIVITY_WRAPPER:
