...
public enum GwtType {
	...
	APP_ENTITY_TYPES_PROCESSOR(GwtPath.MANAGED_REQUEST, false, "",
			...
			"ApplicationDetailsActivities", false, true, false),
	// DETAILS_VIEW(GwtPath.MANAGED_UI, true, "DetailsView", "detailsView",
	// "DetailsView", false, false, false),
	DETAILS_VIEW(GwtPath.MANAGED_UI_IMPL, true, "DetailsView", "detailsView",
			"DetailsView", true, true, false),
	// EDIT_ACTIVITY(GwtPath.MANAGED_ACTIVITY, true, "EditActivity",
	// "editActivity", "EditActivity", false, false, false),
	EDIT_ACTIVITY_WRAPPER(GwtPath.MANAGED_ACTIVITY, true,
			"EditActivityWrapper", "editActivityWrapper",
			"EditActivityWrapper", false, true, false), EDIT_RENDERER(
			GwtPath.MANAGED_UI_RENDERER, true, "ProxyRenderer", "renderer",
			"EditRenderer", false, false, false),
	// EDIT_VIEW(GwtPath.MANAGED_UI, true, "EditView", "editView", "EditView",
	// false, false, false),
	EDIT_VIEW(GwtPath.MANAGED_UI_IMPL, true, "EditView", "editView",
			"EditView", true, true, false), IS_SCAFFOLD_MOBILE_ACTIVITY(
			...
			"ApplicationListPlaceRenderer", false, true, false), LIST_VIEW(
			GwtPath.MANAGED_UI_IMPL, true, "ListView", "listView", "ListView",
			true, true, false), MASTER_ACTIVITIES(GwtPath.MANAGED_ACTIVITY,
			false, "", "masterActivities", "ApplicationMasterActivities",
			false, true, false),
