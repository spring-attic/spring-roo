...
public enum GwtType {
    ...
    APP_ENTITY_TYPES_PROCESSOR(GwtPath.MANAGED_REQUEST, false, "",
            ...
            "DetailsView", false, false, false), DETAILS_VIEW_IMPL(
            GwtPath.MANAGED_UI_IMPL, true, "DetailsViewImpl",
            "detailsViewImpl", "DetailsViewImpl", true, true, false), EDIT_ACTIVITY(
            ...
            true, "EditView", "editView", "EditView", false, false, false), EDIT_VIEW_IMPL(
            GwtPath.MANAGED_UI_IMPL, true, "EditViewImpl", "editViewImpl",
            "EditViewImpl", true, true, false), IS_SCAFFOLD_MOBILE_ACTIVITY(
            ...
            "ApplicationListPlaceRenderer", false, true, false), LIST_VIEW_IMPL(
            GwtPath.MANAGED_UI_IMPL, true, "ListViewImpl", "listViewImpl",
            "ListViewImpl", true, true, false), MASTER_ACTIVITIES(
    ...
    private List<GwtType> resolveReferences(final GwtType type) {
        ...
        case ACTIVITIES_MAPPER:
            return Arrays.asList(GwtType.APP_REQUEST_FACTORY,
                    ...
                    GwtType.LIST_VIEW_IMPL, GwtType.DETAILS_VIEW_IMPL,
                    GwtType.MOBILE_DETAILS_VIEW, GwtType.EDIT_VIEW_IMPL,
