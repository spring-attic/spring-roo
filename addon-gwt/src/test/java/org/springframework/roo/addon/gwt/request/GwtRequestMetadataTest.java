...
public class GwtRequestMetadataTest {
	...
	public void testInstanceDoesNotEqualNull() {
		// Set up
		final GwtRequestMetadata instance = new GwtRequestMetadata(MID_1, CONTENTS);
	...
	public void testInstancesWithSameContentsAreEqual() {
		// Set up
		final GwtRequestMetadata instance1 = new GwtRequestMetadata(MID_1, CONTENTS);
		final GwtRequestMetadata instance2 = new GwtRequestMetadata(MID_2, CONTENTS);
	...
	public void testInstancesWithDifferentContentsAreNotEqual() {
		// Set up
		final GwtRequestMetadata instance1 = new GwtRequestMetadata(MID_1, CONTENTS);
		final GwtRequestMetadata instance2 = new GwtRequestMetadata(MID_1, CONTENTS + "x");
