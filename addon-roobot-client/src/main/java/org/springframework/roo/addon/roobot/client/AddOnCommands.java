...
public class AddOnCommands implements CommandMarker {
	...
	public void infoId(
		@CliOption(key={"", "searchResultId"}, mandatory=true, help="The bundle ID as presented via the addon list or addon search command") String bundleId) {	
	...
	public void infoBundle(
		@CliOption(key = "bundleSymbolicName", mandatory = true, help = "The bundle symbolic name for the add-on of interest") AddOnBundleSymbolicName bsn) {
	...
	public void list(
		...
		addOnRooBotOperations.searchAddOns(true, null, refresh, linesPerResult, maxResults, trustedOnly, compatibleOnly, communityOnly, null);
	}
	
	@CliCommand(value = "addon search", help = "Search all known Spring Roo Add-ons")
	public void search(
		@CliOption(key = { "", "requiresDescription" }, mandatory = false, specifiedDefaultValue = "*", unspecifiedDefaultValue = "*", help = "A comma separated list of search terms") String searchTerms, 
		@CliOption(key = "refresh", mandatory = false, unspecifiedDefaultValue = "false", specifiedDefaultValue = "true", help = "Refresh the add-on index from the Internet") boolean refresh, 
		@CliOption(key = "linesPerResult", mandatory = false, unspecifiedDefaultValue = "2", specifiedDefaultValue = "2", help = "The maximum number of lines displayed per add-on") int linesPerResult, 
		...
		addOnRooBotOperations.searchAddOns(true, searchTerms, refresh, linesPerResult, maxResults, trustedOnly, compatibleOnly, communityOnly, requiresCommand);
	}
	...
	public void remove(
		@CliOption(key = "bundleSymbolicName", mandatory = true, help = "The bundle symbolic name for the add-on of interest") BundleSymbolicName bsn) {
	...
	public void ugradeBundle(
		@CliOption(key = "bundleSymbolicName", mandatory = true, help = "The bundle symbolic name for the add-on to upgrade") AddOnBundleSymbolicName bsn) {
	...
	public void ugradeAvailable(
		@CliOption(key = "addonStabilityLevel", mandatory = false, help = "The stability level of add-ons or components which are presented for upgrading (default: ANY)") AddOnStabilityLevel level) {
