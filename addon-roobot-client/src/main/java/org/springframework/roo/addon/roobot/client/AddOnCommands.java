...
public class AddOnCommands implements CommandMarker {
	...
	public void installBsn(@CliOption(key="bundleSymbolicName", mandatory=true, help="The bundle symbolic name for the add-on of interest") final AddOnBundleSymbolicName bsn) {
	...
	public void ugradeSettings(@CliOption(key = "addonStabilityLevel", mandatory = false, help = "The stability level of add-ons or components which are presented for upgrading") final AddOnStabilityLevel level) {
