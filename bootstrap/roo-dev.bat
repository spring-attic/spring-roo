...
:launch
java -DdevelopmentMode=true %ROO_OPTS% -Droo.home="%USERPROFILE%/roo-dev" -cp %ROO_CP% -Djava.ext.dirs="%USERPROFILE%/roo-dev/work;%JAVA_HOME%/jre/lib/ext" org.springframework.roo.bootstrap.Bootstrap "classpath:/roo-bootstrap.xml" %*
