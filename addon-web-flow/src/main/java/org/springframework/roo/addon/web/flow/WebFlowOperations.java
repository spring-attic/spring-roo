...
public interface WebFlowOperations {
	 ...
	 * The first time a flow is installed, Web Flow related configuration will also be
	 * added.
	 * 
	 * The flow directory is expected to be used exclusively for flow-related artifacts.
	 * A new flow will not be created if the flow directory already exists.   
	 * 
