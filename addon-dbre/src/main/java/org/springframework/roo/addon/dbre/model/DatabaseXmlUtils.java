...
public abstract class DatabaseXmlUtils {
	 ...
	 * 
	 * @param document
	 *            the XML document containing the parent and child (required)
	 * @param parent
	 *            the parent element to which to add a child (required)
	 * @param key
	 *            the option key/name (required)
	 * @param value
	 *            the option value
	 */
	...
	public static Document getDatabaseDocument(final Database database) {
		...
		databaseElement.appendChild(createOptionElement("tablePrefixes",
				StringUtils.join(database.getTablePrefixes(), " "), document));
	...
	static Database readDatabaseWithDom(final InputStream inputStream) {
		...
		for (final Element optionElement : optionElements) {
			...
			if (key.equals("tablePrefixes")) {
				Set<String> str = new HashSet<String>();
				String[] split = value.split(" ");
				for (String s : split) {
					str.add(s);
				}
				database.setTablePrefixes(str);
			}
