...
public abstract class DbreTypeUtils {
	 ...
	 *            a set of database-managed entities to search (required)
	 * @param table
	 *            the table to locate (required)
	 ...
	 * 
	 * @param <T>
	 *            the expected annotation value type
	 * @param type
	 *            the type whose annotations to read (required)
	 * @param annotationType
	 *            the annotation to read (required)
	 * @param attributeName
	 *            the annotation attribute to read (required)
	 * @return
	 */
	 ...
	 * 
	 * @param annotatedType
	 *            the type for which to read the annotations (required)
	 * @param annotationAttributes
	 *            the annotation/attribute pairs to read for that type
	 ...
	 * 
	 * @param name
	 *            the name of the table or column (required)
	 ...
	 * 
	 * @param tableName
	 *            the table name to convert (required)
	 * @param javaPackage
	 *            the Java package to use for the type
	 * @param tablePrefixes
	 *            the prefixes to be removed when generating entities
