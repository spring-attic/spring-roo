                ...
                <div class="form-group has-error has-feedback" data-z="${z}" id="selector"
                    ...
                    <div class="col-md-6">
                      ...
                      <select id="${detail.fieldName}" name="${detail.fieldName}Ids"
                        ...
                        data-ajax--delay="250"
                        multiple="multiple"
                        data-data-ajax--url="${r"${"}(#mvc.url('${dconfig.mvnCollectionControllerName}#${dconfig.mvcMethodName_select2}')).build()}"
              ...
              <div class="form-group">
                <div class="col-md-9 col-md-offset-3">
                    <button type="reset" class="btn btn-default"
                      ...
                      data-th-onclick="'location.href=\'' + ${r"${"}(#mvc.url('${mvcCollectionControllerName}#${mvcMethodName_list}')).build()} + '\''"
