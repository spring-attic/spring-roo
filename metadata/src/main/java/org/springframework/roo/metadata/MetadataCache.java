 ...
 * 
 * <p>
 * A cache is a "best effort" cache and does not need to guarantee to include every item of
 * metadata. Implementations should take care to ensure excessive memory consumption does not
 * occur as a result of their operation. It is recommended that least recently used metadata
 * instances are automatically removed should consumption exceed an implementation-defined threshold.
 * 
 * @author Ben Alex
 * @since 1.0
 *
...
public interface MetadataCache {
	 ...
	 * 
	 * <p>
	 * If the metadata instance does not presently exist in the cache, this is considered
	 * a non-fatal event and the method will simply return.
	 * 
	 * @param metadataIdentificationString to evict (mandatory and must refer to a specific item instance)
	 */
	 ...
	 * 
	 * <p>
	 * This method can be used during reload/refresh-style operations or where there is a
	 * requirement to guarantee cache consistency. 
	 * 
	 */
	void evictAll();
