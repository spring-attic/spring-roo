...
public interface MetadataItem {
	...
	/**
	 * Returns the unique ID of this piece of metadata within the user's project.
	 *
	 * @return a non-blank ID that satisfies {@link MetadataIdentificationUtils#isIdentifyingInstance(String)})
	 */
	String getId();
