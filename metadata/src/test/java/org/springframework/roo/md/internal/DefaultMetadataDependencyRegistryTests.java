...
public class DefaultMetadataDependencyRegistryTests {
	...
	private static final String JAVA_TYPE_PERSON = MetadataIdentificationUtils.create("com.Test", "person");
	private static final String MVC_CONTROLLER = MetadataIdentificationUtils.create("com.Test", "mvc ctrl");
