...
public class FinderMetadataProviderImpl extends AbstractMemberDiscoveringItdMetadataProvider
    implements FinderMetadataProvider {
  ...
  protected ItdTypeDetailsProvidingMetadataItem getMetadata(
    ...
    return new FinderMetadata(metadataIdentificationString, aspectName,
        governorPhysicalTypeMetadata, null, Collections.<JavaSymbolName, QueryHolder>emptyMap());
  }
  ...
  protected DynamicFinderServices getDynamicFinderServices() {
    ...
    try {
      ServiceReference<?>[] references =
          context.getAllServiceReferences(DynamicFinderServices.class.getName(), null);
