...
public interface DynamicFinderServices {
   ...
   */
  List<JavaSymbolName> getFinders(MemberDetails memberDetails, String plural, int depth,
  ...
  QueryHolder getCountQueryHolder(MemberDetails memberDetails, JavaSymbolName finderName,
      String plural, String entityName);
}
