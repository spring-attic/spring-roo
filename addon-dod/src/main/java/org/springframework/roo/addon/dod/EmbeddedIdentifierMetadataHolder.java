...
public class EmbeddedIdentifierMetadataHolder {
	...
	public EmbeddedIdentifierMetadataHolder(FieldMetadata embeddedIdentifierField, List<FieldMetadata> identifierFields, ConstructorMetadata identifierConstructor) {
