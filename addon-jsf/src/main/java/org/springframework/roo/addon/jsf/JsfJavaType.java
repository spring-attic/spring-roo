...
public class JsfJavaType {
	...
	public static final JavaType UI_SELECT_ITEM = new JavaType("javax.faces.component.UISelectItem");
	...
	public static final JavaType PRIMEFACES_KEYBOARD = new JavaType("org.primefaces.component.keyboard.Keyboard");
