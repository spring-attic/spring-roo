...
/**
 * Simplified immutable representation of a plugin repository.
 * 
 * <p>
 ...
 * @since 1.1
 */
public class PluginRepository implements Comparable<PluginRepository> {
	private String id;
	private String name;
	private String url;
	 ...
	 */
	public PluginRepository(String id, String name, String url, boolean enableSnapshots) {
		Assert.hasText(id, "Group ID required");
	 ...
	 */
	public PluginRepository(Element element) {
	...
	public boolean equals(Object obj) {
		return obj != null && obj instanceof PluginRepository && this.compareTo((PluginRepository)obj) == 0;
	}
