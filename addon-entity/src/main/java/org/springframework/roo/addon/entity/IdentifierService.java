...
public interface IdentifierService {
	...
	/**
	 * For the given type, returns zero or more identifier fields that the type requires.
	 * An implementation may return null if they do not have knowledge of any identifier
	 * fields for that type. An implementation returning a non-null value indicates the
