 ...
 *
 * <p>
 * Using this annotation also triggers {@link RooSerializable} and {@link RooConfigurable}.
 *
 * @author Alan Stewart
 * @since 1.1
 */
...
public @interface RooIdentifier {
	...
	/**
	 * Allows disabling the automated creation of a no-arg constructor. This might be appropriate, for example, if another add-on is providing more sophisticated constructor creation facilities.
	 *
	 * @return whether to generate a no-argument constructor in this class (defaults to true)
	 */
