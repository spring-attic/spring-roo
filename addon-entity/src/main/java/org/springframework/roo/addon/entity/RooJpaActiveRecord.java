...
import static org.springframework.roo.addon.entity.RooJpaEntity.VERSION_COLUMN_DEFAULT;
...
public @interface RooJpaActiveRecord {
	 ...
	 * (defaults to {@value #FIND_ENTRIES_METHOD_DEFAULT}, with the simple name
	 * of the entity appended after the specified method name, followed by
	 * "Entries"; mandatory)
	 */
	 ...
	 * method that should be created as a "dynamic finder" by an additional
	 * add-on that can provide implementations of such methods (optional)
	 */
	String[] finders() default "";

	/**
	 * @return the prefix of the "find" (by identifier) method to generate
	 * (defaults to {@value #FIND_METHOD_DEFAULT}, with the simple name of the
	 * entity appended after the specified method name; mandatory)
	 */
	String findMethod() default FIND_METHOD_DEFAULT;

	/**
	 * @return the name of the "flush" method to generate (defaults to {@value #FLUSH_METHOD_DEFAULT}; mandatory)
	 */
