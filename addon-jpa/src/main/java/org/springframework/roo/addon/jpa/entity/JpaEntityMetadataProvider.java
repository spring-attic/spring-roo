 ...
 * {@link JpaActiveRecordMetadataProvider} the management of core JPA concerns such as
 * the id and version fields and applying the JPA @Entity and @Table
 * annotations. The {@link JpaActiveRecordMetadataProvider} remains responsible for CRUD
