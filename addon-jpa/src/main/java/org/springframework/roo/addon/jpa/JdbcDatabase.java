...
public enum JdbcDatabase {
	...
	POSTGRES("POSTGRES", "org.postgresql.Driver", "jdbc:postgresql://HOST:5432"), 
	MYSQL("MYSQL", "com.mysql.jdbc.Driver", "jdbc:mysql://HOST:3306"), 
	ORACLE("ORACLE", "oracle.jdbc.OracleDriver", "jdbc:oracle:thin:@HOST:1521"), 
	SYBASE("SYBASE", "net.sourceforge.jtds.jdbc.Driver", "jdbc:jtds:sybase://HOST:5000/TO_BE_CHANGED_BY_ADDON;TDS=4.2"), 
	MSSQL("MSSQL", "net.sourceforge.jtds.jdbc.Driver", "jdbc:jtds:sqlserver://HOST:1433/TO_BE_CHANGED_BY_ADDON"), 
	DB2("DB2", "com.ibm.db2.jcc.DB2Driver", "jdbc:db2://HOST:50000"), 
	DB2400("DB2400", "com.ibm.as400.access.AS400JDBCDriver", "jdbc:as400://HOST"), 
