...
public enum JdbcDatabase {
	...
	SYBASE("SYBASE", "net.sourceforge.jtds.jdbc.Driver", "jdbc:jtds:sybase://localhost:5000/TO_BE_CHANGED_BY_ADDON;TDS=4.2"), 
	MSSQL("MSSQL", "net.sourceforge.jtds.jdbc.Driver", "jdbc:jtds:sqlserver://localhost:1433/TO_BE_CHANGED_BY_ADDON"), 
