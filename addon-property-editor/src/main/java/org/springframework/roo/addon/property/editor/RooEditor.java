...
* 
* <p>
* This annotation will cause ROO to produce code that would typically appear in a property editor which, in 
...
* 
* <ul>
* <li>The user provides the equivalent object himself. ROO will check for this by naming convention where it will look for a class name with 
* the 'Editor' suffix in the same directory for types that require editors.</li>
* </ul>
* 
...
public @interface RooEditor {
	...
	/**
	 * Every editor is responsible for a single java object. The editor will be created for the object defined 
	 * here.
	 */
