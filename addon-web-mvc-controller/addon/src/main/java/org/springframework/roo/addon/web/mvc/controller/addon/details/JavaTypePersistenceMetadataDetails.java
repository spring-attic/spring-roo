package org.springframework.roo.addon.web.mvc.controller.addon.details;
...
public class JavaTypePersistenceMetadataDetails {
  ...
  public JavaTypePersistenceMetadataDetails(final JavaType identifierType,
      final FieldMetadata identifierField, final MethodMetadata identifierAccessorMethod,
      final MethodMetadata versionAccessorMethod, final MemberTypeAdditions persistMethod,
      final MemberTypeAdditions mergeMethod, final MemberTypeAdditions removeMethod,
      final MemberTypeAdditions findAllMethod, final MemberTypeAdditions findAllSortedMethod,
      final MemberTypeAdditions findMethod, final MemberTypeAdditions countMethod,
      final MemberTypeAdditions findEntriesMethod,
      final MemberTypeAdditions findEntriesSortedMethod, final List<String> finderNames,
      final boolean isRooIdentifier, final List<FieldMetadata> rooIdentifierFields) {
    Validate.notNull(identifierType, "Indentifier type required");
    Validate.notNull(identifierField, "Indentifier field required");
    Validate.notNull(identifierAccessorMethod, "Indentifier accessor method required");
