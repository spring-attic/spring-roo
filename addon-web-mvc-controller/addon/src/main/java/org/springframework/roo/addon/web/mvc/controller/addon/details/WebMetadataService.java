...
public interface WebMetadataService {
  ...
  Map<MethodMetadataCustomDataKey, MemberTypeAdditions> getCrudAdditions(JavaType domainType,
      String metadataIdentificationString);

  Map<JavaSymbolName, DateTimeFormatDetails> getDatePatterns(JavaType javaType,
      MemberDetails memberDetails, String metadataIdentificationString);

  List<JavaTypeMetadataDetails> getDependentApplicationTypeMetadata(JavaType javaType,
      MemberDetails memberDetails, String metadataIdentificationString);
   ...
   */
  Set<FinderMetadataDetails> getDynamicFinderMethodsAndFields(JavaType formBackingType,
      MemberDetails formBackingTypeDetails, String consumingMetadataId);
  ...
  JavaTypePersistenceMetadataDetails getJavaTypePersistenceMetadataDetails(JavaType javaType,
      MemberDetails memberDetails, String metadataIdentificationString);
   ...
   */
  SortedMap<JavaType, JavaTypeMetadataDetails> getRelatedApplicationTypeMetadata(JavaType baseType,
      MemberDetails baseTypeDetails, String metadataId);
