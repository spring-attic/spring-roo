...
public class JavaTypeMetadataDetailsTest {
  ...
  private JavaTypeMetadataDetails getTestInstance(final JavaType javaType) {
    return new JavaTypeMetadataDetails(javaType, "the-plural", false, false, null,
        "the-controller-path");
  }
  ...
  public void testInstancesWithDifferentJavaTypesAreNotEqual() {
    ...
    final JavaTypeMetadataDetails otherJavaTypeMetadataDetails =
        mock(JavaTypeMetadataDetails.class);
