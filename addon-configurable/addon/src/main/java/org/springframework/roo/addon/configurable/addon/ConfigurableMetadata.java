...
public class ConfigurableMetadata extends AbstractItdTypeDetailsProvidingMetadataItem {
  ...
  public ConfigurableMetadata(final String identifier, final JavaType aspectName,
  ...
  public String toString() {
    ...
    builder.append("configurableIntroduced", getTypeAnnotation(CONFIGURABLE) != null);
