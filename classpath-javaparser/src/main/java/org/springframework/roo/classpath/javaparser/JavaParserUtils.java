...
public final class JavaParserUtils {
	 ...
	 *            the types in the compilation unit (required)
	 * @param nameExpr
	 *            the expression to locate an import for (which would generally
	 *            be a {@link NameExpr} and thus not have a package identifier;
	 *            required)
	 ...
	 *            names to consider type parameters (can be null if there are
	 *            none)
	 ...
	 * 
	 * @param compilationUnitServices
	 *            to use for package resolution (required)
	 * @param type
	 *            to locate (required)
	 * @param typeParameters
	 *            names to consider type parameters (can be null if there are
	 ...
	 *            the type declaration to resolve (required)
	 * @return the effective Java type (never null)
	 */
	public static JavaType getJavaType(
			final CompilationUnitServices compilationUnitServices,
	 ...
	 * 
	 * @param className
	 *            to convert (required; can be fully qualified or simple name
	 *            only)
	 ...
	 * @param value
	 *            that expression, which need not necessarily be resolvable to a
	 *            type (required)
	 ...
	 * @param o2
	 *            the second entry to compare (null is acceptable)
