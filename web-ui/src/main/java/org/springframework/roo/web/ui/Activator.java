        ...
        httpTracker = new ServiceTracker(context, HttpService.class.getName(),
            ...
            public void removedService(ServiceReference reference,
                ...
                try {
                    ...
                    LOGGER.log(Level.FINE,
                            "Servlet registration probably failed earlier.");
                }
            }
            ...
            public Object addingService(ServiceReference reference) {
                ...
                try {
                    ...
                    httpService.registerServlet("/", new RedirectServlet(
                            CONTEXT_PATH.concat("/index.html")), null, null);
                    ...
                    LOGGER.log(Level.SEVERE,
                            "Unabled to connect to 'http://localhost:9191/'",
                            ex);
                }
                return httpService;
            }
