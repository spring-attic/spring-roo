...
public class WebXmlUtilsTest {
	...
	public void testSetDisplayName() {
		...
		final Element display = XmlUtils.findFirstElement("display-name", webXml.getDocumentElement());
	...
	public void testSetDescription() {
		...
		final Element desc = XmlUtils.findFirstElement("description", webXml.getDocumentElement());
		assertNotNull(desc);
	...
	public void testAddContextParam() {
		...
		final Element ctxp = XmlUtils.findFirstElement("context-param", webXml.getDocumentElement());
		assertNotNull(ctxp);
	...
	public void testAddFilter() {
		...
		final Element filter = XmlUtils.findFirstElement("filter", webXml.getDocumentElement());
		...
		final List<Element> initParams = XmlUtils.findElements("init-param", filter);
	...
	public void testAddFilterAtPosition() {
		...
		final List<Element> filters = XmlUtils.findElements("filter", webXml.getDocumentElement());
	...
	public void testAddListener() {
		...
		final Element listener = XmlUtils.findFirstElement("listener", webXml.getDocumentElement());
	...
	public void testAddServlet() {
		...
		final Element servlet = XmlUtils.findFirstElement("servlet", webXml.getDocumentElement());
		...
		final List<Element> initParams = XmlUtils.findElements("init-param", servlet);
		assertEquals(2, initParams.size());
		assertEquals(2, initParams.get(0).getChildNodes().getLength());
	...
	public void testSetSessionTimeout() {
		...
		final Element time = XmlUtils.findFirstElement("session-config/session-timeout", webXml.getDocumentElement());
		assertNotNull(time);
	...
	public void testAddWelcomeFile() {
		...
		final Element welcomeFile = XmlUtils.findFirstElement("welcome-file-list/welcome-file", webXml.getDocumentElement());
	...
	public void testAddExceptionType() {
		...
		final Element errorPage = XmlUtils.findFirstElement("error-page", webXml.getDocumentElement());
	...
	public void testAddErrorCode() {
		...
		final Element errorPage = (Element) webXml.getDocumentElement().getChildNodes().item(webXml.getDocumentElement().getChildNodes().getLength() - 1);
		assertNotNull(errorPage);
		assertEquals(2, errorPage.getChildNodes().getLength());
	...
	public void testAddSecurityConstraint() {
		...
		final Element secConstraint = XmlUtils.findFirstElement("security-constraint", webXml.getDocumentElement());
		assertNotNull(secConstraint);
		assertEquals("displayName", XmlUtils.findFirstElement("display-name", secConstraint).getTextContent());
		final Element webResourceCollection = XmlUtils.findFirstElement("web-resource-collection", secConstraint);
		...
		final Element authConstraint = XmlUtils.findFirstElement("auth-constraint", secConstraint);
		assertNotNull(authConstraint);
		assertEquals(2, authConstraint.getChildNodes().getLength());
		final Element userDataConstraint = XmlUtils.findFirstElement("user-data-constraint", secConstraint);
