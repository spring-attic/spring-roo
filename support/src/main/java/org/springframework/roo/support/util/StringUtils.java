...
public final class StringUtils {
     ...
     * @param replacement the string to replace it with (can be
     ...
     *            or null, may be null; note that if this is an expression, it
     *            will be evaluated before this method is called regardless of
     ...
     * </pre>
     * 
     * @param original the String to get a substring from, may be
     *            <code>null</code>
