...
public final class RooObjectUtils {
     ...
     * Return a hash code based on the contents of the specified array.
     * 
     * @param array the array from whose elements to calculate the hash code
     ...
     * 
     * @param object the object to represent as a String (can be
     *            <code>null</code>)
     * @param defaultValue the value to return if the given object is
     *            <code>null</code> (can itself be blank)
     * @return see above
     * @since 1.2.0
     */
