...
public final class NumberUtils {
     ...
     * @return the maximum value in the array, or null if all the elements are
     *         null
     */
     ...
     * 
     * @param array an array of Numbers (can be <code>null</code>)
     * @return the minimum value in the array, or null if all the elements are
     *         null
     */
     ...
     * @param numbers can be <code>null</code>, empty, or contain
