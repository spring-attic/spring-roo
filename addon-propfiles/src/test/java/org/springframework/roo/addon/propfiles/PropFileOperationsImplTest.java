...
/**
 * Unit test of {@link PropFileOperationsImpl}
 *
 * N.B. for this test to pass, the following folder must be on the classpath:
 *
 * <code>org.springframework.roo.addon.propfiles/src/test/resources</code>
 *
...
public class PropFileOperationsImplTest {
	...
	public void testLoadPropertiesFromClasspathWhenItExists() {
		// Invoke
		final Properties properties = this.propFileOperations.loadProperties("bike.properties", PropertiesTestClient.class);
