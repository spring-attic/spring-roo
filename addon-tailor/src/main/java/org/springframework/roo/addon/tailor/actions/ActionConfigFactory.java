...
public class ActionConfigFactory {
   ...
   */
  public static ActionConfig defaultArgumentAction(final String argument, final String defaultValue) {
  ...
  public static ActionConfig defaultArgumentAction(final String argument,
    ...
    final ActionConfig config = new ActionConfig(ActionType.DEFAULTVALUE.getActionId());
