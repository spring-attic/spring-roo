...
public class TailorHelperTest {
  ...
  public void testReplaceVarsDuplicatePlaceholders() {
    ...
    final String expectedResult =
        "module create --moduleName otherdomainname --topLevelPackage com.foo.sample.otherdomainname";
    Assert.assertEquals("Unexpected result: " + result, expectedResult, result);
  }
  ...
  public void testReplaceVarsForUnnamedArgument() {
    final CommandTransformation rooCommand = new CommandTransformation("cd test-data");
    final String result = TailorHelper.replaceVars(rooCommand, "module focus --moduleName ${*}");
